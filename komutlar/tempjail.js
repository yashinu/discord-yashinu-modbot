...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  message.channel.send(embed.setImage(`https://media.discordapp.net/attachments/737636676855267380/740498082139078727/elraen.gif`).setDescription(`${uye} üyesi, ${message.author} tarafından **${sure}** boyunca **${reason}** nedeniyle jaile atıldı!`)).catch();
...
module.exports.configuration = {
  name: "prison",
  aliases: [`jail`, 'tempcezalı', 'süreli-cezalı', 'prison'],
  usage: "prison [üye] [süre] [sebep]",
