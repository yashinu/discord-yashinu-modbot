...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  if(ayar.sesMuteLogKanali && client.channels.cache.has(ayar.sesMuteLogKanali)) client.channels.cache.get(ayar.sesMuteLogKanali).send(embed.setDescription(`${uye} üyesi, ${message.author} tarafından **${sure}** boyunca **${reason}** nedeniyle seste mutelendi!`)).catch();
};
