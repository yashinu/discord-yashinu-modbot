...
module.exports.execute = async(client, message, args, ayar, emoji) => {
  ...
  let embed = new MessageEmbed().setAuthor(message.guild.name, message.guild.iconURL({dynamic: true})).setThumbnail(message.guild.iconURL({dynamic: true})).setFooter(conf.durum).setColor("RANDOM").setTimestamp();
